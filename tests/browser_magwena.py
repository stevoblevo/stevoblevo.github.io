...
with sync_playwright() as pw:
 ...
 try:
  ...
  p.goto(VIEW+'#javascript:bad');expect(p.locator('#status')).to_contain_text('Unknown');expect(p.locator('#download')).to_be_disabled();ok('unrecognized addresses never select an arbitrary picture or action')
